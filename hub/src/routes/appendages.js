...
//
// Lists JSON-defined appendage contracts from /opt/nest/appendages/, marks installed status from agent data + SSH-discovered hosts, and dispatches install_appendage / install_compose_appendage commands. Exports: appendageRoutes(router). Depends: ../appendages.js, ../ws/agentHandler.js, ../ssh-discovery.js.
